...
public class CameraControlsFP : MonoBehaviour
{
    ...
    public float HeighOffset = 0.25f;
    ...
    public void SetTarget(Transform t)
    {
        ...
        offset.y = target.GetComponent<CharacterController>().height - HeighOffset; //Set camera height according to target height
    }
}